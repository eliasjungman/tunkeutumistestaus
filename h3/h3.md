...
Ei toiminut silti. Ajattelin vielä kokeilla oletus salasanalla jos pääsisi sisään mysql
...
Olisi ollut kuitenkin mielenkiintoista tietää olisiko haavoittuvuus toiminut jos salasana olisi määritelty, koska yleensä oletan että salasana on ja se on hyvä. Tai siis ei pidä olettaa mitään koska metasploitablessa pääsi vaan ilman salasanaa sisälle sql.
