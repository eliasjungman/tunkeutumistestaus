...
Arvoidessani muiden opiskelijoiden tehtäviä, keksin miksi ei toimi:
https://github.com/bhm512/tunkeutumistestaus/blob/main/h5.md

Toisen opiskelijan mukaan ffuf.test url pitää vaihtaa localhost

Tämä käy järkeen. Localhost tietenkin, ffuf.test menee johonkinrandom urliin.

Tässä on varmaankin tapahtunut jokin kirjoitusvirhe ffufin tekijällä tms.
